...
module.exports = {
  ...
  group: 'Anime',
  description: `Searches for a specific anime in [MyAnimeList](https://myanimelist.net "Homepage"), or shows bot\'s anime series information if no query is provided.`,
  ...
  run: async ( client, message, args ) => {
    ...
    return message.channel.send(
      ...
      .setFooter(`Anime Query with | \©️${new Date().getFullYear()} ${client.user.username}`)
