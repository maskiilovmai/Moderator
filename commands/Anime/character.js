...
module.exports = {
  ...
  group: 'Anime',
  description: `Searches for a character in [MyAnimeList](https://myanimelist.net "Homepage"), or bot\'s character information if no query is provided.`,
  ...
  run: async (client, message, args) => {
    ...
    .setFooter(`Character Query with  | \©️${new Date().getFullYear()}${client.user.username}`);
