...
module.exports = {
  ...
  group: 'Anime',
  description: 'Search for seiyuu\'s on your favorite anime characters, or bot\'s seiyuu if no query is provided!',
  ...
  run: async ( client, message, args) => {
    ...
    .setFooter(`Seiyuu Query with AL | \©️${new Date().getFullYear()} ${client.user.username}`)
    ...
    .setFooter([
      ...
      `Seiyuu Query with ALi | \©️${new Date().getFullYear()} ${client.user.username}`
    ].join('\u2000•\u2000'));
