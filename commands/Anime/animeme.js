...
module.exports = {
  ...
  description: 'Generate an anime meme fetched from selected <:Reddit:919803880974471179> [Subreddits](https://reddit.com "Homepage"). Include `reload` parameter to reload meme cache. Memes generated are in order by default, add `r`, `random`, or `randomize` to randomize meme.',
